    ...
    public class TagsController : Controller
    {
        ...
        public IActionResult UpdatePost(int id, IFormCollection fc)
        {
            try
            {
                ...
                TempData["SuccessMessage"] = $"Cập nhật dữ liệu tag thành công!";
            }
            catch (Exception)
            {
                TempData["ErrorMessage"] = $"Có lỗi khi thực hiện cập nhật tag!";
            }
        ...
        public IActionResult Delete(int id)
        {
            try
            {
                ...
                TempData["SuccessMessage"] = $"Xóa thành công tag!";
            }
            catch(Exception)
            {
                TempData["ErrorMessage"] = $"Có lỗi thực hiện xóa tag!";
            }
