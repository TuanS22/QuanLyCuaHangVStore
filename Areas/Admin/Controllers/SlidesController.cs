    ...
    public class SlidesController : Controller
    {
        ...
        public IActionResult UpdatePost(int id, IFormCollection fc)
        {
            try
            {
                ...
                if(list_slides != null)
                {
                    ...
                    // thông báo 
                    TempData["SuccessMessage"] = $"Cập nhật thành công slide!";
                }    
                else
                {
                    TempData["ErrorMessage"] = $"Không tìm thấy slide!";
                }    
            }
            catch (Exception)
            {
                // thông báo lỗi
                TempData["ErrorMessage"] = $"Có lỗi xảy ra khi cập nhật slide!";
            }
        ...
        public IActionResult Delete(int id)
        {
            try
            {
                ...
                TempData["SuccessMessage"] = $"Xóa thành công slide!";
                    
            }
            catch (Exception)
            {
                TempData["ErrorMessage"] = $"Có lỗi xảy ra khi xóa slide";
            }
