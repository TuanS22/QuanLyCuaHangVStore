	...
	public class ProductsController : Controller
	{
		...
		public IActionResult CreatePost(IFormCollection fc)
		{
			try
			{
                ...
                double _OriginalPrice = Convert.ToDouble(fc["OriginalPrice"].ToString());
		...
		public IActionResult Update(int id)
		{
			...
			var products = db.Products.FirstOrDefault(item => item.Id == id);
		...
		public IActionResult UpdatePost(int id, IFormCollection fc)
		{
			try
			{
				...
				if(list_products != null)
				{
                    ...
                    list_products.OriginalPrice = _OriginalPrice;
                ...
                TempData["SuccessMessage"] = $"Cập nhật thành công sản phẩm!";
            }
			catch(Exception)
			{
