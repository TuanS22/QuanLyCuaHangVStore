...
{
	[Area("Admin")]
	public class UsersQtvController : Controller
	{
		public MyDbContext db = new MyDbContext();
		public IActionResult Index()
		{
			return RedirectToAction("Read", "UsersQtv", new { area = "Admin" });
		}
		...
		{
			// tạo biến action
			ViewBag.action = "/Admin/UsersQtv/CreatePost";
		...
		public IActionResult Update(int id)
		{
			...
			ViewBag.action = "/Admin/UsersQtv/UpdatePost/" + id;
		...
		public IActionResult UpdatePost(int id, IFormCollection fc)
		{
			try
			{
				...
				ItemUsers list_record = new ItemUsers();
