	...
	public class HomeQtvController : Controller
	{
		...
		public IActionResult CreatePost(IFormCollection fc)
		{
			...
			{ 
                ...
                // kiểm tra trong csdl đã tồn tại tài khoản chưa
                ItemAdmin record_check = db.Admin.FirstOrDefault(item => item.Email == _Email);
		...
		public IActionResult UpdatePost(int id, IFormCollection fc)
		{
			try
			{
				...
				if(list_admin != null)
				{
                    ...
                    // thông báo 
                    TempData["SuccessMessage"] = $"Cập nhật thành công tài khoản admin!";
                }
            }
			catch (Exception )
			{
        ...
        public IActionResult Delete(int id)
        {
            try
            {
                ...
                TempData["SuccessMessage"] = $"Xóa thành công admin";
