    ...
    public class AdvController : Controller
    {
        ...
        public IActionResult UpdatePost(int id, IFormCollection fc)
        {
            try
            {
                ...
                TempData["SuccessMessage"] = $"Cập nhật ảnh quảng cáo thành công!";
            }
            catch (Exception)
            {
                TempData["ErrorMessage"] = $"Có lỗi xảy ra khi cập nhật ảnh quảng cáo!";
            }
        ...
        public IActionResult Delete(int id)
        {
            try
            {
                ...
                TempData["SuccessMessage"] = $"Xóa thành công ảnh quảng cáo!";
            }
            catch 
            {
                TempData["ErrorMessage"] = $"Có lỗi xảy ra khi xóa ảnh quảng cáo!";
            }
