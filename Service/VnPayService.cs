...
namespace VStore.Service
{
    public class VnPayService : IVnPayService
    {
        ...
        public string CreatePaymentUrl(HttpContext context, VnPaymentRequestModel model)
        {
            ...
            vnpay.AddRequestData("vnp_TxnRef", model.OrderId.ToString()); // Mã tham chiếu của giao dịch tại hệ thống của merchant.Mã này là duy nhất dùng để phân biệt các đơn hàng gửi sang VNPAY.
        ...
        public VnPaymentResponseModel PaymentExecute(IQueryCollection collections)
        {
            ...
            var vnp_BankCode = vnpay.GetResponseData("vnp_BankCode"); // Get the bank code
            var vnp_Amount = Convert.ToInt64(vnpay.GetResponseData("vnp_Amount")) / 100; // Get the amount
            ...
            return new VnPaymentResponseModel
            {
                ...
                BankCode = vnp_BankCode, // Set the bank code
                Amount = vnp_Amount, // Set the amount
